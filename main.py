...
class Game():      
    ...
    player1limitX = (0, barPosX - barWidth - 40)     
    player2limitX = (barPosX + barWidth + 40, screenWidth - barWidth)
...
#        self.hitSound = QtGui.
    ...
    def retranslateGameTypeUi(self):
        ...
        self.p2p.setText(_translate("MainWindow", "Player"))
...
#                print('distance travelled = ', x_)
            ...
            if stone.stoneX > Game.barPosX - 30 - Game.stoneWidth  and stone.stoneX < Game.barPosX + 30 + Game.barWidth:
...
#        print(self.position)
    ...
    def paintField(self):
        ...
        self.painter.fillRect(0, Game.screenHeight - Game.fieldHeight,
                          Game.screenWidth, Game.fieldHeight, Game.fieldColor)
        self.painter.fillRect(Game.barPosX+30, Game.barPosY, Game.barWidth,
                          Game.barHeight, Game.barColor)
        self.painter.fillRect(Game.barPosX-30, Game.barPosY, Game.barWidth,
                          Game.barHeight, Game.barColor)
        ...
        self.scoreText1 = '<b style="font-size:20px;">Player : ' + str(player1.score) + " " + str(player1.throw) + '<\b>'
        
        self.scoreText2 = '<b style="font-size:20px;">AI : ' + str(player2.score) +  " " + str(player2.throw) + '<\b>'
